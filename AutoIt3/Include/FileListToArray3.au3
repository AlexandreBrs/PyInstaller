;  FileListToArray3.au3 from http://www.autoitscript.com/forum/index.php?showtopic=49396

#AutoIt3Wrapper_Au3Check_Parameters= -d -w 1 -w 2 -w 3 -w 4 -w 5 -w 6
;===============================================================================
;
; Description:      lists all files and folders in a specified path
; Syntax:           _FileListToArray($s_Path, $s_Filter = "*", $i_Flag = 0, $i_Recurse = 0, $i_BaseDir = 1, $s_Exclude = "", $i_Options = 0)
...
;					$i_Options = Delete or not duplicate file.
;						$i_Options=0 (Default) Do not delete duplicate file.
;						$i_Options=1 Delete duplicate file.
;
; Requirement(s):   None
...
;
;===============================================================================
Func _FileListToArray3($sPath, $sFilter = "*", $iFlag = 0, $iRecurse = 0, $iBaseDir = 1, $sExclude = "", $i_Options = 0)
